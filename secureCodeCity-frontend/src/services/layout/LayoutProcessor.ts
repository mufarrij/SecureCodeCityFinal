...
import secureCodeCityModel from "./secureCodeCityModel";
...
class LayoutProcessor {
    ...
    public getIllustration(options: {}, model: secureCodeCityModel) {
    ...
    private _RuleHouseHeight() {
        ...
        if (this._options.scalingMethod === "logarithmic") {
            ...
            return new CodeCityVis.rules.math.logarithmic({
                condition: (model: secureCodeCityModel, node: TreeNodeInterface) => model && node.children.length === 0,
